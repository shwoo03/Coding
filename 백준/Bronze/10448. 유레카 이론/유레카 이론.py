triangular_numbers = [1, 3, 6, 10, 15, 21, 28, 36, 45, 55, 66, 78, 91, 105, 120, 136, 153, 171, 190, 210, 231, 253, 276, 300, 325, 351, 
                    ...
                    3828, 3916, 4005, 4095, 4186, 4278, 4371, 4465, 4560, 4656, 4753, 4851, 4950, 5050]

# Set 자료구조를 이용하여 삼각수를 빠르게 조회할 수 있게 합니다.
triangular_set = set(triangular_numbers)

def ConditionJudgment(n):
    for x in triangular_numbers:
        for y in triangular_numbers:
            z = n - x - y
            # z가 triangular_set에 있는지 확인합니다.
            if z in triangular_set:
                return True
    return False
